...
export function SettingsPage({ snapshot, client, onError }: { snapshot: UiSnapshot; client: DesktopClient; onError: (message: string) => void }) {
  ...
  return <div className="page">
    ...
    <div className="notice" style={{ marginTop: 18 }}><Icon name="shield" size={17} /><div><strong>设置仅作用于当前设备</strong><p>不会自动修改其他设备的外观与隐私选项。</p></div></div>
  </div>;
}
