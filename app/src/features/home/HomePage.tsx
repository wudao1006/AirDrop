...
export function HomePage({ snapshot, client, onError, openClipboard }: { snapshot: UiSnapshot; client: DesktopClient; onError: (message: string) => void; openClipboard: () => void }) {
  return <div className="page">
    ...
    {snapshot.clipboardCapability.limitation && <div className="notice" style={{ marginTop: 12 }}><Icon name="shield" size={17} /><div><strong>部分剪贴板能力受限</strong><p>{snapshot.clipboardCapability.limitation}</p></div></div>}
